...
export const AGENTS: Agent[] = [
  ...
  { id: 'agent-3',  num: 3,  name: 'Outbound B2B',           fleet: 'Sales & Marketing', status: 'planned', desc: 'Cold outreach — picks up ICP from Buyer Hunter, sends Meta templates, nurtures into Qualifier.', icon: 'send', planCopy: { whatItDoes: 'Bulk-import contacts → Meta-approved template → reply lands in #1 → nurture by stage.', inputs: ['Contact CSV', 'Approved WA template', 'Cadence rules'], outputs: ['Conversations seeded', 'Reply rate', 'Lifecycle events'], eta: 'After cockpit V1' } },
  ...
  { id: 'agent-6',  num: 6,  name: 'Buyer Hunter',           fleet: 'Sales & Marketing', status: 'planned', desc: 'Scrapes ICP contacts per vertical (hotels, hospitals, factories) from IndiaMART, directories.', icon: 'target', planCopy: { whatItDoes: 'Scrapes ICP contacts per vertical for cold outbound.', inputs: ['Vertical', 'Geo', 'Filters'], outputs: ['Contacts with name/phone/email/source'], eta: 'Day 22-28' } },
