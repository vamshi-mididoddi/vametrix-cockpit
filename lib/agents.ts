...
export const AGENTS: Agent[] = [
  ...
  { id: 'agent-7',  num: 7,  name: 'Creative Factory',       fleet: 'Sales & Marketing', status: 'live',    desc: 'Generates ad images (Nano Banana) + copy variants + video briefs. Approval queue before push to Meta.', icon: 'sparkles' },
  { id: 'agent-8',  num: 8,  name: 'Performance Marketer',   fleet: 'Sales & Marketing', status: 'live',    desc: 'Strategist + tech auditor + ad launcher + daily audit + CAPI quality + auto-execute. End-to-end ROAS brain.', icon: 'bar-chart-3' },
